...
regressors <- c("bedrooms", "bathrooms", "fee", "has_photo",
                    "pets_allowed",
                    "population")
add_col <- c("density", "square_feet")
i <- 2
...
new7_sub <- c(NA, NA, as.numeric(new7[3:7]))
new8_sub <- c(NA, NA, as.numeric(new8[3:7]))
diff <- round(c(ne7_sub - new8_sub), 3)

mat <- matrix(data=c(new7, new8, diff), nrow=3, byrow=TRUE, )
