...
x <- cleaned %>%
      select(bathrooms, bedrooms, square_feet, fee, has_photo, pets_allowed, density, population) %>%
  mutate(bathrooms = as.numeric(bathrooms), bedrooms = as.numeric(bedrooms), square_feet = as.numeric(square_feet), fee = as.numeric(fee), has_photo = as.numeric(has_photo), pets_allowed = as.numeric(pets_allowed), density = as.numeric(density), population = as.numeric(population))
